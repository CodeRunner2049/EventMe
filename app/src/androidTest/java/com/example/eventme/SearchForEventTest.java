...
public class SearchForEventTest {
    ...
    @Test
    public void searchForEventTest() {
        ...
        ViewInteraction searchAutoComplete2 = onView(
                allOf(withClassName(is("android.widget.SearchView$SearchAutoComplete")), withText("head"),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        searchAutoComplete2.perform(replaceText("coach"));

        ViewInteraction searchAutoComplete3 = onView(
                allOf(withClassName(is("android.widget.SearchView$SearchAutoComplete")), withText("coach"),
                        childAtPosition(
                                allOf(withClassName(is("android.widget.LinearLayout")),
                                        childAtPosition(
                                                withClassName(is("android.widget.LinearLayout")),
        ...
        ViewInteraction textView2 = onView(
                allOf(withId(R.id.Name), withText("Coachella"),
                        withParent(withParent(withId(R.id.mRecyclerView))),
                        isDisplayed()));
        textView2.check(matches(withText("Coachella")));
    }
